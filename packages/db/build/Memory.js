...
var _MemoryDb = _interopRequireDefault(require("./engines/MemoryDb"));

var _TransactionDb = _interopRequireDefault(require("./engines/TransactionDb"));
 ...
 * ```
 */
class Memory extends _TransactionDb.default {
  constructor() {
    super(new _MemoryDb.default());
  }
